...
L'objectif est de proposer une alternative aux applications comme Uber Eats, mais plus respectueuse de l'environnement et des données personnelles des utilisateurs.
