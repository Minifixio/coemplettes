...
As the grocery prices are very high on the plateau, the app allows students to go shopping in more affordable supermarkets (located further away) and to take other students' shopping list and buy their groceries. 
