...
Dès lors, il es possible de distinguer différents produits
...
sur ces mêmes platformes.

C'est sur le principe de livraison que notre application 
se rapproche des exemples cités précedemment.
...
et des applcations de livraison.
