...
class API {
    ...
    constructor(port, tag) {
        ...
        this.entryPoints = [
            ...
            { method: "POST", entryPointName: "update_user", paramName: null, auth: true, callbackParam: (user) => DBManager_1.DB.updateUser(user) },
            ...
            { method: "POST", entryPointName: "cart_retreive", paramName: null, auth: true, callbackParam: (data) => DBManager_1.DB.retreiveCart(data.cart_id) },
            { method: "POST", entryPointName: "cart_finish", paramName: null, auth: true, callbackParam: (data) => DBManager_1.DB.finishCart(data.cart_id, data.retreived) },
            { method: "POST", entryPointName: "delivery_proposal_accept", paramName: null, auth: true, callbackParam: (data) => DBManager_1.DB.acceptDeliveryProposal(data.delivery_proposal_id) },
            { method: "POST", entryPointName: "delivery_proposal_decline", paramName: null, auth: true, callbackParam: (data) => DBManager_1.DB.delcineDeliveryProposal(data.delivery_proposal_id) },
